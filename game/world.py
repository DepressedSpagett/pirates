...
class World (context.Context):
    ...
    def __init__ (self, s):
        ...
        island_list = [island.Island, coolplaces.Island,KraggyRockIsland.KraggyRockIsland]
        ...
        KraggyRockIsland = KraggyRockIsland.KraggyRockIsland (self.startx, self.starty+1, self)
        self.locs[self.startx][self.starty+1] = KraggyRockIsland
        ...
        self.events.append (kraken_encounter.KrakenEncounter())
